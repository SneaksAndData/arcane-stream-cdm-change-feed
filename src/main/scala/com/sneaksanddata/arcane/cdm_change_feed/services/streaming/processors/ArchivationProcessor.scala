package com.sneaksanddata.arcane.cdm_change_feed.services.streaming.processors

import com.sneaksanddata.arcane.cdm_change_feed.services.clients.{BatchArchivationResult, JdbcConsumer}
